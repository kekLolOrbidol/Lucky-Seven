...
import com.santtuhyvarinen.gameideagenerator.MainActivity

class PushReceiver : BroadcastReceiver() {

    override fun onReceive(context: Context, intent: Intent) {
        val type = intent.getIntExtra(com.santtuhyvarinen.gameideagenerator.notification.Notification.TYPE_EXTRA, 0)
        ...
        val nm = com.santtuhyvarinen.gameideagenerator.notification.Notification().getNotificationManager(context)
